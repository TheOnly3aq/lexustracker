      ...
      {cards.map((card, index) => (
        ...
        >
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-xs sm:text-sm font-medium text-gray-300 group-hover:text-white transition-colors duration-300">
              {card.title}
            </CardTitle>
            <div
          ...
          <CardContent className="pt-0">
            <div className="flex items-center space-x-2">
              <div className="text-xl sm:text-2xl font-bold text-white group-hover:text-white transition-colors duration-300">
                {loading ? (
